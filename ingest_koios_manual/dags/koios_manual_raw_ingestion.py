...
# SCRIPTS_DIR = "/usr/local/airflow/drugdevelopment/dags/scripts/drugdevelopment/ingest_koios_manual"
...
with DAG(
    "koios_manual_raw_ingestion",
    default_args=default_args,
    description="koios raw ingestion for manual files",
    schedule= None,
