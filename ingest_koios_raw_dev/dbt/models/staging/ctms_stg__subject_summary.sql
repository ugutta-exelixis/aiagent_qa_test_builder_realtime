...
,last_modified_date as EDC_Data_Refreshed_Date
from 
    {{ source ('koios_raw', 'subject_summary_xl184-312') }} 
    where last_modified_date = (select max(last_modified_date) from {{ source ('koios_raw', 'subject_summary_xl184-312') }})
    and partition_date = (select max(partition_date) from {{ source ('koios_raw', 'subject_summary_xl184-312') }})
...
,last_modified_date as EDC_Data_Refreshed_Date
from 
    {{ source ('koios_raw', 'subject_summary_xl184_311') }}
    where last_modified_date = (select max(last_modified_date) from {{ source ('koios_raw', 'subject_summary_xl184_311') }} )
    and partition_date = (select max(partition_date) from {{ source ('koios_raw', 'subject_summary_xl184_311') }} )
...
,last_modified_date as EDC_Data_Refreshed_Date
from
    {{ source ('koios_raw', 'xb010-101_subject_summary') }}
    where last_modified_date = (select max(last_modified_date) from {{ source ('koios_raw', 'xb010-101_subject_summary') }})
