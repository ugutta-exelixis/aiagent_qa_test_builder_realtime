...
DBT_PROJECT_DIR = "/tmp/drugdevelopment/ingest_koios_raw_dev"
...
with DAG(
    "koios_mart_datamodel_dev",
    # These args will get passed on to each operator
    # You can override them on a per-task basis during operator initialization
    default_args=default_args,
    description="[Development] koios main dag in mwaa clearlake for mart datamodel",
    schedule=None,
    ...
    start = BashOperator(
        task_id="start",
        env={'DAPLEX_KOIOS_HOST': '{{ var.value.DAPLEX_KOIOS_HOST_DEV }}', 'DAPLEX_KOIOS_USER':
             '{{ var.value.DAPLEX_KOIOS_USER_DEV }}', 'DAPLEX_KOIOS_PASSWORD': '{{ var.value.DAPLEX_KOIOS_PASSWORD_DEV }}',
             'DAPLEX_KOIOS_DB': '{{ var.value.DAPLEX_KOIOS_DB_DEV }}','DAPLEX_KOIOS_SCHEMA': '{{ var.value.DAPLEX_KOIOS_SCHEMA_DEV }}'},
