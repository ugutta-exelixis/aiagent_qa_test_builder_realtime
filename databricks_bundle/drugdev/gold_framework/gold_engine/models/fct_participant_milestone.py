# src/gold/models/fct_participant_milestone.py
...
class FctParticipantMilestoneModel(GoldModel):
    name         = "fct_participant_milestone"
    write_mode   = "overwrite"
    dependencies = []
    class_path   = "gold.models.fct_participant_milestone.FctParticipantMilestoneModel"
    ...
    def build(self, spark: SparkSession, silver: Dict[str, DataFrame], meta: Dict[str, DataFrame]) -> DataFrame:
        ...
        return (sm
                ...
                .select(
                    ...
                    F.to_date(F.upper(F.col("milestone_date")), "dd-MMM-yyyy").alias("milestone_date"),
