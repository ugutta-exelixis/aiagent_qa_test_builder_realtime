...
SCRIPTS_DIR = "/usr/local/airflow/drugdevelopment/dags/scripts/drugdevelopment/ingest_koios_manual_dev"
...
with DAG(
    "koios_manual_raw_ingestion_dev",
    default_args=default_args,
    schedule=None,
    description="koios manual raw ingestion development",
