...
variance = int(Variable.get("koios_time_delta"))
...
# with open('/usr/local/airflow/dags/scripts/drugdevelopment/ingest_koios_manual_dev/DaPlex_Ingestion_Config.json', 'r') as json_file:
#     config_data = json.load(json_file)
...
yesterday_date_pst = current_date_pst - timedelta(days=variance)
